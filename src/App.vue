<template>
	...
	<div class="modal" :class="{ 'HIDE' : hide_modal, 'SHOW' : show_modal }">
		<div class="main">
			...
			<h1 class="heading">Milijan Mosić</h1>
		</div>
...
<style>
	...
	.modal
	{
		@apply flex flex-col justify-center w-full rounded-3xl z-10 bg-white mos:w-96 mos:shadow-lg;
	}

	.main
	{
		@apply flex flex-col justify-center w-full rounded-3xl shadow-lg bg-white;
	}

	.img
	{
		@apply w-full h-auto rounded-3xl;
	}

	.heading
	{
		@apply -mt-2 pb-4 text-center text-5xl font-semibold;
	}

	.dots
	{
		@apply flex flex-col justify-center items-center pt-8 pb-4 rounded-bl-3xl rounded-br-3xl shadow-lg text-2xl;
	}

	.links
	{
		@apply grid grid-cols-3 gap-y-4 place-items-center pt-8 pb-4 rounded-bl-3xl rounded-br-3xl shadow-lg;
	}
	...
	@media only screen and (min-width: 1024px)
	{
		...
		.main
		{
			@apply flex flex-row flex-wrap justify-center shadow-none rounded-3xl;
		...
		.side
		{
			...
			background: linear-gradient(90deg, rgba(255, 255, 255, 1) 0%, rgba(107, 114, 128, 1) 100%); 
		}
		...
		.heading
		{
			@apply m-0 p-0 text-6xl;
		}

		.dots
		{
			@apply flex flex-row justify-around pt-8 pb-8 font-bold;
		}
